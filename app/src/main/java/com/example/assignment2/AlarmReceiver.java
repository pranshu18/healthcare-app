...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        setAlarm(context, username, password);
    }
    ...
    public void setAlarm(Context context, String username, String password)
    {
        ...
        i.putExtra(CommonUtilities.USER_NAME,username);
        i.putExtra(CommonUtilities.PASSWORD,password);
        PendingIntent pi = PendingIntent.getBroadcast(context, 0, i, 0);
        assert am != null;
        am.setExactAndAllowWhileIdle(AlarmManager.ELAPSED_REALTIME, SystemClock.elapsedRealtime() + 900000, pi);
    }
    ...
    private void createOrSetDb(String username, String password) {
        ...
        db = SQLiteDatabase.openOrCreateDatabase(folder.getPath() + File.separator + username, password, null);
        db.beginTransaction();
        try {
